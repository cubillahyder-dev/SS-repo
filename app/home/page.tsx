...
import { Heart, MessageCircle, Share2, MoreHorizontal, Droplets } from "lucide-react"
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 lg:flex lg:gap-8">
      ...
      <div className="flex-1 space-y-6">
        ...
        {/* Daily Status (Mobile Only) */}
        <div className="lg:hidden flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
            <Card className="min-w-[160px] bg-blue-50 border-blue-100 p-4 rounded-2xl">
                <div className="flex items-center gap-2 mb-2">
                    <Droplets className="h-5 w-5 text-blue-500" />
                    <span className="font-bold text-blue-700">Water</span>
                </div>
                <div className="text-2xl font-bold text-blue-900">1.2L</div>
                <div className="text-xs text-blue-600">Target: 2.5L</div>
            </Card>
            <Card className="min-w-[160px] bg-green-50 border-green-100 p-4 rounded-2xl">
                <div className="flex items-center gap-2 mb-2">
                    <span className="text-lg">🥗</span>
                    <span className="font-bold text-green-700">Meal Plan</span>
                </div>
                <div className="text-xs text-green-600 mb-2">Lunch: Chicken & Rice</div>
                <Button size="sm" variant="outline" className="h-6 text-[10px] w-full border-green-200 text-green-700 hover:bg-green-100" asChild>
                    <Link href="/nutrition">View</Link>
                </Button>
            </Card>
        </div>
